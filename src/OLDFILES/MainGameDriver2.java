...
public class MainGameDriver2 {
    private GameLayout gameLayout;
    private static String selectedLocation;

    public MainGameDriver2(GameLayout gameLayout) {
...
//    }
     ...
     */
    public static MainGameDriver2 loadGameState(String filename) throws IOException, ClassNotFoundException {
        GameLayout gameLayout = GameLayout.loadGameLayout(filename);
        return new MainGameDriver2(gameLayout);
    }
...
//    }
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        MainGameDriver2 gameDriver = new MainGameDriver2(gameLayout);
        ...
        while (true) {
            ...
            if (answer.equals("2")) {
                ...
                gameDriver = new MainGameDriver2(gameLayout);
                break;
            } else {
